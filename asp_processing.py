...
def download_and_unzip_asp(file_list):
    ...
    for file in file_list:
        ...
        try:
            ...
            if year == 2020:
                ...
                response = requests.get('https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Part-B-Drugs/McrPartBDrugAvgSalesPrice/downloads/' + file_name + '?agree=yes&next=Accept')
...
def clean_and_combine_asp(file_list):
